...
export default function Footer() {
  return (
    <footer className="bg-[#111D15] px-8 lg:px-24 py-8 md:pt-18 md:pb-8 text-white">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 text-white pb-12 gap-1">
            <div className="space-y-5 md:col-span-2 lg:col-span-2 mb-6">
