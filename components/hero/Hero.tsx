...
export default function Hero() {
  return (
    <div className="px-8 md:px-24 py-8 md:h-[500px] bg-[url('/hero_image.png')] bg-cover md:bg-cover bg-no-repeat bg-center bg-amber-800 flex flex-col justify-center">
