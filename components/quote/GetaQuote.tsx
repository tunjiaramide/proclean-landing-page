...
export default function GetaQuote() {
  return (
    <div className="px-8 md:px-24 py-8 md:py-16 flex justify-between items-center">
            <div className="flex flex-col space-y-3.5 w-1/2">
                <h6 className="font-normal text-[16px]">Affordable cleaning solutions</h6>
                <h2 className="text-[44px] font-bold leading-[120%]">High-Quality and Friendly Services at Fair Prices</h2>
